...
namespace WebApp.Controllers
{
    public class CurrentStocksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Quantity,LastUpdated,ProductId,StorageRoomId,Id,Comment")] CurrentStock currentStock)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Products, "Id", "Name", currentStock.ProductId);
            ViewData["StorageRoomId"] = new SelectList(_context.StorageRooms, "Id", "Name", currentStock.StorageRoomId);
            return View(currentStock);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Quantity,LastUpdated,ProductId,StorageRoomId,Id,Comment")] CurrentStock currentStock)
        {
