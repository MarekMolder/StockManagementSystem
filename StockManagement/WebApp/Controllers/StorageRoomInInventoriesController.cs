...
namespace WebApp.Controllers
{
    public class StorageRoomInInventoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CreatedAt,EndedAt,InventoryId,StorageRoomId,Id,Comment")] StorageRoomInInventory storageRoomInInventory)
        {
            ...
            ViewData["InventoryId"] = new SelectList(_context.Inventories, "Id", "Name", storageRoomInInventory.InventoryId);
            ViewData["StorageRoomId"] = new SelectList(_context.StorageRooms, "Id", "Name", storageRoomInInventory.StorageRoomId);
            return View(storageRoomInInventory);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("CreatedAt,EndedAt,InventoryId,StorageRoomId,Id,Comment")] StorageRoomInInventory storageRoomInInventory)
        {
