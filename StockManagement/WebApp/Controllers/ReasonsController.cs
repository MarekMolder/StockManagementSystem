...
namespace WebApp.Controllers
{
    public class ReasonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Description,CreatedAt,EndedAt,Id,Comment")] Reason reason)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Description,CreatedAt,EndedAt,Id,Comment")] Reason reason)
        {
            if (id != reason.Id)
            {
                return NotFound();
