...
namespace WebApp.Controllers
{
    public class ActionTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,CreatedAt,EndedAt,Id,Comment")] ActionType actionType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Name,CreatedAt,EndedAt,Id,Comment")] ActionType actionType)
        {
            if (id != actionType.Id)
            {
                return NotFound();
