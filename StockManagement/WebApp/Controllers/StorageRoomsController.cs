...
namespace WebApp.Controllers
{
    public class StorageRoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Location,LastUpdated,CreatedAt,EndedAt,Id,Comment")] StorageRoom storageRoom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Name,Location,LastUpdated,CreatedAt,EndedAt,Id,Comment")] StorageRoom storageRoom)
        {
